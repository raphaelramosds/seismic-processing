...
O modelo de velocidades gerado para essa questão foi gerado em [modelo_velocidades_2d.m](./modelo_velocidades_2d.m). Execute esse script para gerar o arquivo `vel.out`, que sera usado para gerar o modelo de velocidades.
